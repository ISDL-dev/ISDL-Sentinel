 ...
 * 
 * @export
 * @interface GetUsersInfo200ResponseInner
 */
export interface GetUsersInfo200ResponseInner {
    /**
     * 
     * @type {number}
     * @memberof GetUsersInfo200ResponseInner
     */
    'user_id': number;
    /**
     * 
...
export const SettingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getUsersInfo: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        putUserById: async (userId: number, putUserByIdRequest?: PutUserByIdRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
            assertParamExists('putUserById', 'userId', userId)
            const localVarPath = `/users/{user_id}`
                .replace(`{${"user_id"}}`, encodeURIComponent(String(userId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const SettingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUsersInfo(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GetUsersInfo200ResponseInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUsersInfo(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SettingApi.getUsersInfo']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async putUserById(userId: number, putUserByIdRequest?: PutUserByIdRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.putUserById(userId, putUserByIdRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SettingApi.putUserById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const SettingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUsersInfo(options?: any): AxiosPromise<Array<GetUsersInfo200ResponseInner>> {
            return localVarFp.getUsersInfo(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Put a user by ID
         ...
         * @throws {RequiredError}
         */
        putUserById(userId: number, putUserByIdRequest?: PutUserByIdRequest, options?: any): AxiosPromise<void> {
            return localVarFp.putUserById(userId, putUserByIdRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SettingApi extends BaseAPI {
     ...
     * @memberof SettingApi
     */
    public getUsersInfo(options?: RawAxiosRequestConfig) {
        return SettingApiFp(this.configuration).getUsersInfo(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SettingApi
     */
    public putUserById(userId: number, putUserByIdRequest?: PutUserByIdRequest, options?: RawAxiosRequestConfig) {
        return SettingApiFp(this.configuration).putUserById(userId, putUserByIdRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
