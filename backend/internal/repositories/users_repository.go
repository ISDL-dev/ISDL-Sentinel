...
func GetAllUserRepository() (userList *sql.Rows, err error) {
	userList, err := infrastructures.DB.Query("SELECT id, name, mail_address, password, status_id, place_id, grade_id FROM user")
	if err != nil {
